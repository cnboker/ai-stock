...
def tune(ticker):
    ...
    optimizer = SmartOptimizer(ticker)
...
if __name__ == "__main__":
    ...
    liveTikers = LivePositionLoader.load_tickers("state/live_positions.yaml")
    task_queue = watchlist + liveTikers
