...
class BudgetManager:
    ...
    def get_budget(
        ...
        kelly_budget = (
            equity * min(self.kelly_fraction, self.single_position_limit) * smooth_score
        )
        ...
        print(
            ...
            f"kelly_budget:{kelly_budget:.0f}, | Final:{final_budget:.0f}"
        )
...
budget_mgr = BudgetManager(
    ...
    min_trade_value=5000.0,  # 低于 3000 元不玩
)
